...
async function main() {
  ...
  const defaultRolePermissions = {
    SUPERADMIN: {
      ...
      score: 'edit', visits: 'edit', units: 'edit', expansion: 'edit', royalties: 'edit', marketing: 'edit', users: 'edit',
    },
    MANAGER: {
      dashboard: 'edit', ai: 'edit', ops: 'edit', compliance: 'edit',
      score: 'edit', visits: 'edit', units: 'edit', expansion: 'none', royalties: 'none', marketing: 'none', users: 'none',
    },
    OPERACIONES: {
      dashboard: 'view', ai: 'edit', ops: 'edit', compliance: 'view',
      score: 'view', visits: 'edit', units: 'view', expansion: 'none', royalties: 'none', marketing: 'none', users: 'none',
    },
    FRANQUICIA: {
